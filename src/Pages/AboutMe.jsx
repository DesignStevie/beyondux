    ...
    <>
      ...
      <div className="aboutContainer">
        ...
        <div className="aboutText">
          <h2>I’m a UX/UI Designer working in New Zealand.</h2>
          <div className="paragraph">
            As a designer I have a passion for creating engaging, intuitive
            digital, and beautiful experiences.
            <br />
            <br />
            With over 2+ years of crafting pixel-perfect experiences in the
            digital realm, I'm on a mission to transform the way we interact
            with technology.
            <br />
            <br />
          ...
          <ul>
            ...
            <li>
              learning Unreal Engine, and Unity to create cinematic videos, and
              even create games.
            </li>
