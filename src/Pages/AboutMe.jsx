...
function AboutMe() {
  return (
    <>
      <Nav />
      <div className="aboutIntro">I’m Steven.</div>
      <div className="aboutContainer">
        <div className="profileImage">
          <div className="profileImageContainer">
            <img src={face} alt="Image of Steven" />
          </div>
          <div className="profileSocialContainer">
            <div className="profileSocial">
              ...
              <div className="iconText">
                ...
                <div className="iconTextDescription">Synthwave - Lofi boy</div>
              </div>
            </div>
            <div className="profileSocial">
              <div className="socialIcon">
        ...
        <div className="aboutText">
          <h1>I’m a UX/UI Designer working in New Zealand.</h1>
          <p>
            As a designer I have a passion for creating engaging and intuitive
            digital experiences as well as pursuing a side passion for front end
            development.
          </p>
          <p>
            Over the years I have honed my skills in customer research,
            information architecture, wireframing, prototyping, and visual
            design, using tools such as Figma, Adobe Creative Suite, and VS
            Code. I also facilitate workshops with all my teams including
            designs sprints to quickly and efficiently tackle design problems.
          </p>
          {/* <p>
