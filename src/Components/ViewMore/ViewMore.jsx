    ...
    <div>
      <div className="moreProjects">
        {ProjectData.map((project, key) => {
          return (
            <>
              {props.project !== project.cover.link && (
                <div className="moreProjectsBackground">
                  {project.release ? (
                    <Link
                      key={key}
                  ...
                  <div className="moreProjectContent">
                    <div className="moreProjectItemTitle">
                      <div className="moreProjectTitle">
                        {project.cover.name}
                      </div>
                      <div className="moreProjectDescription">
